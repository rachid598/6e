...
const GAMES = [
  ...
  { id: 'divisix', title: 'Divisix', description: 'Division euclidienne', emoji: '\u2797', color: 'from-emerald-500 to-teal-500', path: '/divisix' },
  { id: 'chrono', title: 'Chrono-Tables', description: '60s, maximum de bonnes reponses', emoji: '\u23F1\uFE0F', color: 'from-red-500 to-orange-500', path: '/chrono' },
...
export default function Hub({ player, onReset, darkMode, onToggleDark, badgeCount }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface dark:bg-gray-900">
      ...
      <footer className="text-center text-xs text-gray-300 dark:text-gray-600 py-3">
        Maths 6e &mdash; PWA v2.0
      </footer>
    </div>
  )
}
